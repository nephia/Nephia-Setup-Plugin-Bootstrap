...
package Nephia::Setup::Plugin::Bootstrap::TwitterBootstrap;
use strict;
use warnings;
...
...
    ...
    open my $fh, '>:utf8', 'lib/Nephia/Setup/Plugin/Bootstrap/TwitterBootstrap.pm';
    print {$fh} $content;
    close $fh;

    eval "use Nephia::Setup::Plugin::Bootstrap::TwitterBootstrap;";
    die $@ if $@;
...
sub get_jQuery {
    ...
    open my $fh, '>:utf8', 'lib/Nephia/Setup/Plugin/Bootstrap/jQuery.pm';
    print {$fh} $xslate->render_string(<<'...', +{ file => $0, basename => basename($url), data => Dumper({ 'js/' . basename($url) => $jquery})});
package Nephia::Setup::Plugin::Bootstrap::jQuery;
use strict;
use warnings;
...
...
    ...
    eval "use Nephia::Setup::Plugin::Bootstrap::jQuery;";
    die $@ if $@;
